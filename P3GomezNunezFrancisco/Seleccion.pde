class Seleccion
{
  ...
  Seleccion(int x_, int y_, int lx_, int ly_,int xpress_, int ypress_,  String leyenda_,String press_, color col_, color col1_,int largo_, int alto_, color col2_,int xa_, int ya_,int xn_, int yn_,int xp_, int yp_)
  {
    x=x_;
    y=y_;
    lx=lx_;
